import { Shield, Zap, Users, TrendingUp, Twitter, ArrowRight } from "lucide-react"
  ...
  return (
    <div className="relative">
      ...
      <section className="relative py-32 px-4 lg:px-8">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-20">
            <h2 className="text-4xl lg:text-5xl font-light text-white mb-8">From Awareness to Action—Inside Twitter</h2>
            <p className="text-white/80 text-xl max-w-4xl mx-auto leading-relaxed">
              Instead of running ads and hoping users click away to complete steps (leading to drop-offs), let users
              take verified actions directly within their Twitter feed.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-16">
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-medium text-white mb-6">Choose an Intent</h3>
              <p className="text-white/70 text-lg leading-relaxed">
                Select from KYC status checks, loyalty verification, on-chain achievements, or any Moca-issued identity
                proof for your campaign.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-medium text-white mb-6">Frame Triggers Proof</h3>
              <p className="text-white/70 text-lg leading-relaxed">
                Users already have their identity and credentials from Moca Identity. We verify the proof on-demand,
                seamlessly inside the Frame.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-medium text-white mb-6">Unlock Action</h3>
              <p className="text-white/70 text-lg leading-relaxed">
                Once verified, users can instantly apply, register, claim, participate, or join—all without leaving
                Twitter.
              </p>
            </div>
          </div>
              ...
              <div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    { title: "Frictionless Conversion Funnel", desc: "Eliminate multiple steps and form abandonment" },
                    {
              ...
              <div>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    { title: "No Extra Steps Required", desc: "One-click verification and action completion" },
                    {
                      title: "One-click Social Interaction",
                      desc: "Seamless integration with their Twitter experience",
                    },
                    { title: "Instant Gratification", desc: "Immediate results without waiting or redirects" },
                    { title: "Stay in Favorite Platform", desc: "Never leave the comfort of their social feed" },
                    { title: "Seamless Social Experience", desc: "Actions feel native to the Twitter environment" },
                  ].map((benefit, index) => (
                    <div key={index} className="group">
      ...
      <section className="relative py-32 px-4 lg:px-8">
        <div className="container mx-auto max-w-7xl">
          <div className="text-center mb-20">
            <h3 className="text-4xl font-medium text-white mb-8">Example Intents</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              { icon: Users, title: "Verify Loyalty", desc: "Confirm membership status and reward eligibility" },
              { icon: Zap, title: "On-chain Achievements", desc: "Validate blockchain credentials and NFT ownership" },
              {
                icon: Twitter,
              ...
              >
                ...
                <h4 className="text-white font-medium text-xl mb-4">{useCase.title}</h4>
      ...
      <section className="relative py-32 px-4 lg:px-8">
        <div className="container mx-auto max-w-5xl">
          <div className="text-center bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-16">
            <h3 className="text-4xl font-medium text-white mb-6">Ready to Convert Users Inside Twitter?</h3>
            <p className="text-white/80 text-xl mb-12 max-w-3xl mx-auto leading-relaxed">
              Join forward-thinking businesses using Moink to turn social attention into verified actions with Moca
              Identity's trust layer.
            </p>
